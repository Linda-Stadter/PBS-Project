...
Die Methode der Geglaetteten Teilchen-Hydrodynamik (SPH) wurde erstmalig von Gingold und Monaghan \citep{gingold1977smoothed} und Lucy \citep{lucy1977numerical} dargestellt. Dabei wurde sie verwendet, um astrophysikalische Probleme wie die Dynamiken von Sternen darzustellen.

Mueller et al. \citep{muller2003particle} wandte SPH zuerst fuer Computergrafik Simulationen in Echtzeit an. Es wurde eine Methode gefunden, die schnell genug war, bis zu 5.000 Partikel in interaktiven Systemen darzustellen.
