...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State \hskip1.0em \textcolor{gray}{Berechne Dichte mit Formel...}
		\State \textbf{Normals Shader}
		\State \hskip1.0em \textcolor{gray}{Oder eine Auflistung der Formeln}
		\State \textbf{Force Shader}
		\State \hskip1.0em \textcolor{gray}{Berechne Kraft mit \ref{force_pressure}, \ref{force_with_surface}}
		\State \textbf{Integration Shader}
		\State \hskip1.0em \textcolor{gray}{Leapfrog-/Euler-Integration mit \ref{leapfrog_r_i+1}, \ref{leapfrog_v_i+1}}
		\EndFor
		\EndWhile
