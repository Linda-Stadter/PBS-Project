...
Für ein ausreichend detailliertes Verhalten der Simulation werden etwa 30.000 Partikel simuliert. Als Kriterium für Echtzeitanforderungen sollen 30 Bilder pro Sekunde erreicht werden. Dies soll auf handelsüblicher Hardware wie der NVIDIA GTX 1070 möglich sein, ohne die Anzahl der Partikel zu verringern.
...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
		...
		\State \hskip1.0em \textcolor{gray}{Weise jedem Partikel Zellindex zu}
		\State \textbf{Bitonic Sort}
		\State \hskip1.0em \textcolor{gray}{Sortiere nach Zellen}
		\State \textbf{Offset Shader}
		\State \hskip1.0em \textcolor{gray}{Abstand zu erstem Partikel jeder Zelle}
		\State \textbf{Density Shader}
		\State \hskip1.0em \textcolor{gray}{Berechne mit Formel \ref{density}}
		\State \textbf{Normals Shader}
		\State \hskip1.0em \textcolor{gray}{Berechne mit Formel \ref{normal}}
		\State \textbf{Force Shader}
		\State \hskip1.0em \textcolor{gray}{Berechne mit \ref{pressure_tait}, \ref{force_pressure}, \ref{force_external}, \ref{force_viscosity},  \ref{force_with_surface}, \ref{spline}, \ref{cohesion}, \ref{curvature}, \ref{surface_tension}}
