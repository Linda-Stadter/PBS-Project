...
static const uint THREADS = 256 *2;
static const uint PARTICLE_COUNT = 2048;

static const float xSPH_h 		= 3.0f;									// smoothing radius
...
static const float xSPH_K					= 250.0f;								// pressure constant
